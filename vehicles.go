...
func vehiclesHandler(request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	//_=returnString
	//_=err
	fmt.Println("You are in Vehicles Dog")
